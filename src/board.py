...
class Board:
    ...
    def move(self, piece, move):
        ...
        final = move.final
        self.squares[initial.row][initial.col].piece = None #magic happens here
        self.squares[final.row][final.col].piece = piece    #magic
    ...
    def calc_moves(self, piece, row, col):
        ...
        def pawn():
            ...
            # initially pawn can move either 1 or 2 steps forward
        ...
        def knight():
            # possible moves list for Knight
            possible_moves = [
            (row - 2, col + 1),
            (row - 1, col + 2),
            (row + 1, col + 2),
    ...
    #add pieces on the board as per initial set-up of chess
